/**
 * Next.js API route that proxies SQL approval resume requests
 * to the FastAPI backend at POST /api/v1/sql-approval/resume.
 *
...
export async function POST(req: Request) {
  ...
  const backendRes = await fetch(`${BACKEND_URL}/api/v1/sql-approval/resume`, {
    method: "POST",
    headers: {
