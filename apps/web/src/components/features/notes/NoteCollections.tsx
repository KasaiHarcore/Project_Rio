...
import { useNoteStore, noteUid, type Collection } from '@/store/note-store'
import { Plus, FolderOpen, MoreHorizontal, Pencil, Trash2, X, Check } from 'lucide-react'
...
export function NoteCollections() {
    ...
    const getNotesForCollection = (colId: string) =>
        notes.filter((n) => n.collectionId === colId).length
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-b border-[var(--note-card-border)] flex items-center justify-between">
                ...
                <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold bg-rose-600 hover:bg-rose-700 text-white transition-colors shadow-lg shadow-rose-900/20"
                >
                    <Plus size={14} />
                    New Collection
                </button>
