...
import { useEmotionalStore, Mood, RelationshipTier } from '@/store/emotional-store'
...
const MOOD_STICKERS: Record<Mood, string> = {
    happy: '/images/sticker/RioHappy.png',
    excited: '/images/sticker/RioWave.png',
    neutral: '/images/sticker/RioSmirk.png',
    sad: '/images/sticker/RioCry.png',
    frustrated: '/images/sticker/RioAngry.png',
    tired: '/images/sticker/RioAmimir.png',
}
...
export function DashboardHero({
    ...
    const stickerSrc = MOOD_STICKERS[mood] ?? MOOD_STICKERS.neutral
