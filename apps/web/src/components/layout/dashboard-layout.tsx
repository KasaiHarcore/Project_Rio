...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className={cn(
        "flex h-screen font-sans text-slate-700 overflow-hidden relative transition-colors duration-1000",
        isPlana ? "bg-[#1a1625] selection:bg-rose-500/30" : "bg-[#F0F7FF] selection:bg-blue-500/30"
    )}>
