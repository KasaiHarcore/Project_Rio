...
from application.workflows.checkpointer import (
    build_config_payload,
    checkpoint_context,
    list_checkpoints as _list_checkpoints,
    load_checkpoint as _load_checkpoint,
)
from application.workflows.memory_store import memory_store_context
from application.workflows.graph import build_workflow_graph
        ...
        with workflow_trace(
            ...
            with checkpoint_context() as checkpointer, memory_store_context() as store:
                ...
                if not checkpoint_id:  # Only clear if not explicitly resuming
                    try:
                        from application.workflows.checkpointer import get_latest_checkpoint_state
                        ...
                        if existing:
                            ...
                            if is_terminal or question_mismatch or mode_mismatch or stale_in_progress:
                                ...
                                from application.workflows.checkpointer import delete_checkpoints
...
def resume_sql_approval(
    *,
    ...
    """
    from infrastructure.dto.schemas.sql_approval import SQLApprovalStatus
