...
MEMORY_ANALYSIS_PROMPT = """I will analyze Sensei's request about memory and determine the action.

Sensei's message: {message}

I will determine:
1. ACTION: Is Sensei asking to STORE something (remember), RECALL something (what do I know), or FORGET something?
...
Examples:
- "Remember that I work at Google" → ACTION: STORE, CONTENT: Sensei works at Google
- "What do you know about me?" → ACTION: RECALL, CONTENT: general information about Sensei
...
class MemoryWorker(BaseWorker):
    ...
    def system_prompt(self) -> str:
        return """I am the Memory module. I manage Sensei's long-term memories so important information is never lost.

My capabilities:
1. STORE: Save facts Sensei explicitly asks me to remember
2. RECALL: Retrieve and list what I know about Sensei
3. FORGET: Remove specific memories when Sensei asks

I am precise about what I store or retrieve. I confirm actions clearly."""
