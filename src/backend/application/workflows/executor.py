        ...
        with workflow_trace(
            ...
            with checkpoint_context() as checkpointer:
                ...
                if not checkpoint_id:  # Only clear if not explicitly resuming
                    try:
                        from backend.application.workflows.checkpointer import get_latest_checkpoint_state
                        ...
                        if existing:
                            ...
                            if is_terminal or question_mismatch or mode_mismatch or stale_in_progress:
                                ...
                                from backend.application.workflows.checkpointer import delete_checkpoints
